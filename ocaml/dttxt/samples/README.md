...
| ----------------- | ------------------------------------------ | ------------ | -------------- |
| breast_cancer.txt | Python sklearn.datasets.load_breast_cancer | 30           | 43             |
| digits.txt        | Python sklearn.datasets.load_digits        | 64           | 321            |
| iris.txt          | Python sklearn.datasets.load_iris          | 4            | 15             |
